...
// E-Mail
$recipient = "youraddresshere@domain.com"; // Address to deliver form to
...
$errorStrings = array(
	...
	4 => 'sendForm24991', // No real error message for this
);
...
if (($input_type == INPUT_POST && !empty($_POST['sendForm24991']) ||
	($input_type == INPUT_GET && !empty($_GET['sendForm24991']))))
{
	// Probably not
	appendError(4);
}
