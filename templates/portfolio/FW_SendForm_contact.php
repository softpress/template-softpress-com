...
// E-Mail
$recipient = "address@domain.com"; // Address to deliver form to
...
$errorStrings = array(
	...
	4 => 'sendForm96846', // No real error message for this
);
...
if (($input_type == INPUT_POST && !empty($_POST['sendForm96846']) ||
	($input_type == INPUT_GET && !empty($_GET['sendForm96846']))))
{
	// Probably not
	appendError(4);
}
...
if (!$errors)
{
	...
	$emailBody = 'Message From Website
