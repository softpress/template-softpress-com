...
// E-Mail
$recipient = "email@address.com"; // Address to deliver form to
...
$errorStrings = array(
	...
	4 => 'sendForm33669', // No real error message for this
);
...
if (($input_type == INPUT_POST && !empty($_POST['sendForm33669']) ||
	($input_type == INPUT_GET && !empty($_GET['sendForm33669']))))
{
	// Probably not
	appendError(4);
}
